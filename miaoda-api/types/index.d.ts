 ...
 * ```
 */
export declare const Action: FunctionComponent<ActionProps> &
  ConvenienceActions & {
 ...
 * ```
 */
export declare const ActionPanel: FunctionComponent<ActionPanelProps_2> &
...
declare type ActionPanelChildren_2 =
  | ReactElement<ActionPanel.Section.Props>
  | ReactElement<ActionPanel.Section.Props>[]
 ...
 */
export declare const ActionPanelItem: FunctionComponent<ActionProps> &
  ConvenienceActions & {
    Style: ActionStyle;
  };
 ...
 */
export declare interface ActionPanelSectionProps
  extends ActionPanel.Section.Props {}
 ...
 */
export declare interface ActionPanelSubmenuProps
  extends ActionPanel.Submenu.Props {}
 ...
 */
export declare interface CopyToClipboardActionProps
  extends Action.CopyToClipboard.Props {}
 ...
 */
declare const DatePicker: ForwardRefExoticComponent<
  DatePickerProps & RefAttributes<FormItemRef>
> &
  DatePickerMembers;
 ...
 */
declare const Dropdown: ForwardRefExoticComponent<
  DropdownProps & RefAttributes<FormItemRef>
> &
  DropdownMembers;
 ...
 */
declare const Dropdown_2: FunctionComponent<DropdownProps_2> &
  DropdownMembers_2;
...
declare interface DropdownProps
  extends FormItemProps_2<string>,
    SearchBarInterface {
  /**
 ...
 */
declare const FilePicker: ForwardRefExoticComponent<
  FilePickerProps & RefAttributes<FilePickerRef>
>;
 ...
 */
export declare const Form: FunctionComponent<FormProps_2> &
  FormMembers &
  DeprecatedFormMembers;
 ...
 */
export declare interface FormDropdownItemProps
  extends Form.Dropdown.Item.Props {}
 ...
 */
export declare interface FormDropdownSectionProps
  extends Form.Dropdown.Section.Props {}
 ...
 */
export declare interface FormItemProps<Value extends Form.Value>
  extends Form.ItemProps<Value> {}
 ...
 */
export declare interface FormTagPickerItemProps
  extends Form.TagPicker.Item.Props {}
 ...
 * ```
 */
export declare function getApplications(
  path?: PathLike
): Promise<Application[]>;
 ...
 * ```
 */
export declare function getDefaultApplication(
  path: PathLike
): Promise<Application>;
 ...
 * ```
 */
export declare function getPreferenceValues<
...
export declare namespace LocalStorage {
   ...
   * ```
   */
  export function getItem<T extends Value = Value>(
    key: string
  ): Promise<T | undefined>;
  /**
 ...
 * ```
 */
export declare const MenuBarExtra: FunctionComponent<MenuBarExtraProps> &
  MenuBarExtraMembers;
 ...
 */
export declare interface OpenInBrowserActionProps
  extends Action.OpenInBrowser.Props {}
 ...
 */
declare const PasswordField: ForwardRefExoticComponent<
  PasswordFieldProps & RefAttributes<PasswordFieldRef>
>;
...
declare type SectionChildren =
  | ReactElement<ActionProps>
  | ReactElement<ActionProps>[]
  | ReactElement<SubmenuProps>
  | Array<ReactElement<SubmenuProps>>
  | Array<ReactElement<SubmenuProps> | ReactElement<ActionProps>>
  | null;
 ...
 */
export declare interface ShowInFinderActionProps
  extends Action.ShowInFinder.Props {}
 ...
 */
export declare interface SubmitFormActionProps<T extends Form.Values>
  extends Action.SubmitForm.Props<T> {}
 ...
 */
declare const TagPicker: ForwardRefExoticComponent<
  TagPickerProps & RefAttributes<FormItemRef>
> &
  TagPickerMembers;
...
declare const TextArea: ForwardRefExoticComponent<
  TextAreaProps & RefAttributes<TextAreaRef>
>;
 ...
 */
declare const TextField: ForwardRefExoticComponent<
  TextFieldProps & RefAttributes<TextFieldRef>
>;
