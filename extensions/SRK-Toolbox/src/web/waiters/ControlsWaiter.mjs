...
class ControlsWaiter {
    ...
    saveButtonClick() {
        ...
        this.app.alert(`流程保存为 "${recipeName}".`, 3000);
    }
    ...
    supportButtonClick(e) {
        ...
        const saveLink = this.generateStateUrl(true, true, null, null, "https://btsrk.me/");
