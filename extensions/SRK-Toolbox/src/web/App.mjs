...
class App {
    ...
    */
    ...
    setCompileMessage() {
        ...
        // }之前
        let compileInfo = `<a target='_blank' href='https://github.com/work7z/MDGJX'>秒达工具箱 - CyberChef中文版</a>`;
    ...
    updateURL(includeInput, input=null, changeUrl=true) {
        ...
        if (recipeConfig.length === 1) {
            ...
            if (ops.length < 45) {
                ...
                title = `${recipeConfig[0].op} 等 ${recipeConfig.length - 1} 项其他操作 - ${title}`;
            }
        }
