 ...
 * ```
 */
class AsanaOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
...
exports.AsanaOAuthService = AsanaOAuthService;
/**
 ...
 * ```
 */
class GitHubOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
                providerName: "GitHub",
                providerIcon: { source: getIcon(PROVIDERS_CONFIG.github.icon), tintColor: api_1.Color.PrimaryText },
                providerId: "github",
 ...
 * ```
 */
class GoogleOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
 ...
 * ```
 */
class JiraOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
...
exports.JiraOAuthService = JiraOAuthService;
/**
 ...
 * ```
 */
class LinearOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
...
exports.LinearOAuthService = LinearOAuthService;
/**
 ...
 * ```
 */
class SlackOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
...
exports.SlackOAuthService = SlackOAuthService;
/**
 ...
 * ```
 */
class ZoomOAuthService extends OAuthService_1.OAuthService {
    constructor(options) {
        super({
            client: new api_1.OAuth.PKCEClient({
                redirectMethod: api_1.OAuth.RedirectMethod.Web,
...
exports.ZoomOAuthService = ZoomOAuthService;
